...
START_TEST(Run_ResourceDenied_NoCallToRenderer)
{
    // Arrange
	MenuController_Init();
    ContentsManagerMock_SetState(DM_STATE_RUN);
    MenuController_Run();
