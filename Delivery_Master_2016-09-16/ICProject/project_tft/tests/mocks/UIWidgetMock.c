...
void UIWidget_Draw(display_area_definition_t* area, const ui_widget_t* uiWidget)
{
    lastDrawTime = clock();
    drawCount++;
}

boolean UIWidget_Refresh(display_area_definition_t* area, const ui_widget_t* uiWidget)
{
