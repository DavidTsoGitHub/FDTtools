...
* \date			2014-01-29
* \brief		portable macros for sockets, threads etc. for Windows and Linux
* \details		https://github.com/cogu/netsocket
*
* Copyright (c) 2014 Conny Gustafsson
*
******************************************************************************/
...
#define THREAD_DESTROY(thread) TerminateThread( thread, 0)
#else
...
#define THREAD_RETURN(retval) return (void*) retval
